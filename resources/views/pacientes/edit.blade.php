...
<meta charset="utf-8">
    ...
    <form action="{{route('pacientes.update', $paciente->id)}}" method="POST" role="form" class="box">
        ...
        <div class="">
                <label for="">DNI</label>
                <input type="text" class="" id="" value="{{$paciente-> dni}}">
        </div>
        <div class="">
            ...
            <div class="">
                ...
                <input type="date" class="form-date" id="" value="{{$paciente-> fecha_nacimiento}}">
            </div>
            <div class="">
            ...
            <div class="">
                ...
                <input type="text" class="" id="" value="{{$paciente-> correo}}">
            </div>
